...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.log("[parse-document] Auth result:", {
    ...
    try {
      ...
      console.error("[parse-document] formData parse error:", err);
      return NextResponse.json(
    ...
    try {
      if (
        ...
        // test fixture at module init time, which throws an "illegal path" error
        // in Next.js server routes. Use dynamic import for ESM compatibility.
